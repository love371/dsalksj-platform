...
export default function PopularPage() {
  ...
  const popularPosts = useMemo(() => posts.slice(0, 12), [posts]);
    ...
    >
      ...
      >
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          >
            Explore the most visible and engaging posts from the platform with the
            same gaming vibe, glowing effects, and premium layout.
          </p>
        </div>
      </section>
      ...
      <PostCardGrid
        ...
        subtitle="Premium content from the homepage, now in its own page."
      />
