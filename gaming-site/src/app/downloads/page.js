...
const animatedTexts = [
  ...
  "Game Access and Files",
  "Playable Content Hub"
];
...
export default function DownloadsPage() {
  ...
  const downloadPosts = useMemo(
    () => posts.filter((post) => post.type === "download"),
    [posts]
  );
    ...
    >
      ...
      >
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          >
            Dedicated download page for game files, download links, and access
            related content with the same premium gaming style.
          </p>
        </div>
      </section>
      ...
      <PostCardGrid
        ...
        subtitle="All download content in one dedicated page."
      />
